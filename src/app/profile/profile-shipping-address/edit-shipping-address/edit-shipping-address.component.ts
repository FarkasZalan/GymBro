...
export class EditShippingAddressComponent {
  ...
  constructor(
    ...
    private dialogRef: MatDialogRef<EditShippingAddressComponent>,
  ...
  private async initializeComponent() {
    await this.loadingService.withLoading(async () => {
      ...
      this.modifyShippingAddressId = this.data.addresId;
      ...
      if ((this.userId !== undefined && this.userId !== null && this.userId !== "") &&
        (this.modifyShippingAddressId !== undefined && this.modifyShippingAddressId !== null && this.modifyShippingAddressId !== "")) {
        this.db.collection("users").doc(this.userId).collection("shippingAddresses").doc(this.modifyShippingAddressId)
